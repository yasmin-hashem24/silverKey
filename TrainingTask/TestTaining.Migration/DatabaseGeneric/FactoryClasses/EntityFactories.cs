...
using TestTraining.EntityClasses;
using TestTraining.HelperClasses;
using TestTraining.RelationClasses;
using SD.LLBLGen.Pro.ORMSupportClasses;

namespace TestTraining.FactoryClasses
{
		...
		where TEntity : EntityBase2, IEntity2
	{
		...
		public EntityFactoryBase2(string entityName, TestTraining.EntityType typeOfEntity, bool isInHierarchy) : base(entityName, (int)typeOfEntity)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((TestTraining.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public StudentEntityFactory() : base("StudentEntity", TestTraining.EntityType.StudentEntity, false) { }
		/// <inheritdoc/>
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(TestTraining.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(TestTraining.EntityType)))
			{
				var factory = GetFactory((TestTraining.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the TestTraining.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(TestTraining.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case TestTraining.EntityType.StudentEntity:
	...
	{
		/// <summary>Gets the factory of the Entity type with the TestTraining.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (TestTraining.EntityType)Enum.Parse(typeof(TestTraining.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((TestTraining.EntityType)Enum.Parse(typeof(TestTraining.EntityType), leftOperandEntityName, false), joinType, (TestTraining.EntityType)Enum.Parse(typeof(TestTraining.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (TestTraining.EntityType)Enum.Parse(typeof(TestTraining.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((TestTraining.EntityType)entityTypeValue); }
