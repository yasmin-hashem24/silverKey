...
using TestTraining.FactoryClasses;
using TestTraining.RelationClasses;

using SD.LLBLGen.Pro.ORMSupportClasses;

namespace TestTraining.EntityClasses
{
	...
	
	{
		...
		protected class StudentEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("StudentEntity", InheritanceHierarchyType.None, false, (int)TestTraining.EntityType.StudentEntity, typeof(StudentEntity), typeof(StudentEntityFactory), false);
			}
		}
		...
		/// <remarks>Mapped on  table field: "Students"."Email".<br/>Table field type characteristics (type, precision, scale, length): Varchar, 0, 0, 255.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		...
		/// <remarks>Mapped on  table field: "Students"."Id".<br/>Table field type characteristics (type, precision, scale, length): Integer, 10, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		...
		/// <remarks>Mapped on  table field: "Students"."Name".<br/>Table field type characteristics (type, precision, scale, length): Varchar, 0, 0, 255.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
...
namespace TestTraining.RelationClasses
{
