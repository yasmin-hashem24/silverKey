...
namespace TestTraining.DatabaseSpecific
{
	...
	internal class PersistenceInfoProviderCore : PersistenceInfoProviderBase
	{
		...
		{
			this.AddElementMapping("StudentEntity", @"test", @"public", "Students", 3, 0);
			this.AddElementFieldMapping("StudentEntity", "Email", "Email", false, "Varchar", 255, 0, 0, false, "", null, typeof(System.String), 0);
			this.AddElementFieldMapping("StudentEntity", "Id", "Id", false, "Integer", 0, 10, 0, true, "public.Students_Id_seq", null, typeof(System.Int32), 1);
